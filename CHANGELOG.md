...
Dev ([`c2337f9`](https://github.com/ruiheesi/DSPWorkflow/commit/c2337f9f2a982dcd720d07363950a75403cc1997))
...
* fix (filtering): Added defaults for parameters, cleaned up error messages and variable names, and fixed print for goi table ([`e91506a`](https://github.com/ruiheesi/DSPWorkflow/commit/e91506a08c0578c3df162d10dae3297f8e99db00))
...
* update test and functions ([`e68cd6f`](https://github.com/ruiheesi/DSPWorkflow/commit/e68cd6fe275dbb9c8601038f1e8d04a76004693e))
...
* Updated nanostringnctools to 1.4.0 ([`7efef6f`](https://github.com/ruiheesi/DSPWorkflow/commit/7efef6fc2ad99b3842d11a9cbac28f78703b1bcb))
...
* qcProc clean warnings 1 ([`694fb61`](https://github.com/ruiheesi/DSPWorkflow/commit/694fb6155263c3232673430a460ba577f7c68b1a))
...
* Updates to description file, mouse int test ([`7b2e447`](https://github.com/ruiheesi/DSPWorkflow/commit/7b2e447dad832942de04aa0472e5f87d79a1cf42))
...
* Updated NSCLC integration test working directory ([`ad69385`](https://github.com/ruiheesi/DSPWorkflow/commit/ad69385edf37d513b5397ffd12b1487ec0dc8ed6))
...
* Update DESCRIPTION to add magrittr and Update readme to use image in vignettes ([`b0eb7f7`](https://github.com/ruiheesi/DSPWorkflow/commit/b0eb7f7c8689e3863582880d48d887dbcbc69cfd))
...
Geo mx norm ([`621689e`](https://github.com/ruiheesi/DSPWorkflow/commit/621689e721e618d1191ba804769b44e11248996c))
...
* Updates ([`3a091a1`](https://github.com/ruiheesi/DSPWorkflow/commit/3a091a157131b23f4b1970581b4dab70c02b0385))
...
* Formatting changes in diffExpr function ([`9128e63`](https://github.com/ruiheesi/DSPWorkflow/commit/9128e63a6447fb45712db7e564b2d12744140114))
...
* Update Helper script for select normalized ([`f579700`](https://github.com/ruiheesi/DSPWorkflow/commit/f57970051912f40928ec372d1f7bb9bcae83c1f8))
...
* dimReduct cleanup ([`096107f`](https://github.com/ruiheesi/DSPWorkflow/commit/096107f88243e01790cc7be05329fd71f7ec1c65))
...
* Add lint test ([`aafe8d8`](https://github.com/ruiheesi/DSPWorkflow/commit/aafe8d8a9480c1617e0b5bc91ae66906cdcdd37a))
...
* Created vignette folder and added all integration test RMD files ([`638a7f0`](https://github.com/ruiheesi/DSPWorkflow/commit/638a7f06a79ef6852a0d4fdbfc5cf00db6e84a6a))
...
* Updated for Species ([`600d400`](https://github.com/ruiheesi/DSPWorkflow/commit/600d4006a34e9612853eb4f01715b3624394044b))
...
* Fixed issue with NULL inputs for NTCCounts, minNuclei, and minArea ([`e549a1c`](https://github.com/ruiheesi/DSPWorkflow/commit/e549a1c6d5a79fed00b4e2969f3d614bebc342a5))
...
* Added NULL conditional to nuclei, area, and NTC params for QC preprocessing step ([`e037c11`](https://github.com/ruiheesi/DSPWorkflow/commit/e037c1156d57f20eca23d90d0e4a33baf1099b06))
...
* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`a3f06fc`](https://github.com/ruiheesi/DSPWorkflow/commit/a3f06fcd1eb2311265caa0955a77a6684e3e1598))

* Changed hardcoded &#34;region&#34; column to user parameter ([`959044b`](https://github.com/ruiheesi/DSPWorkflow/commit/959044b9312bebb25e91124ec469b79e3cfc8dfb))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`cc5b55b`](https://github.com/ruiheesi/DSPWorkflow/commit/cc5b55bebdc16f28dfdb9cad4417e078a05e83df))

* Updated Integration test for Mouse Thymus data and updated Study Design Unit Test ([`6df9522`](https://github.com/ruiheesi/DSPWorkflow/commit/6df9522d93535e903e69bd35bb6390e5dc83caf5))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`be3228e`](https://github.com/ruiheesi/DSPWorkflow/commit/be3228e64d27e826cd97caf2e6f1564db575cae2))

* Changes to Differential Expression Analysis ([`9d103bd`](https://github.com/ruiheesi/DSPWorkflow/commit/9d103bd776fdd63babf8283a5e6314dc840c992b))

* update Unsupervised Analysis &amp; DESCRIPTION ([`1ac4608`](https://github.com/ruiheesi/DSPWorkflow/commit/1ac4608816f601a8d66976a99196ef67286a1c8d))

* Added Markdown file for Integration Testing. ([`da7e28a`](https://github.com/ruiheesi/DSPWorkflow/commit/da7e28a7ffa3a436b6a4ec5eee808eec8ab99e53))

* Updated study design unit test ([`9e4a6d0`](https://github.com/ruiheesi/DSPWorkflow/commit/9e4a6d035b68cd55b584ec1a34cd69130f30f6c6))

* Changes to Differential Expression Analysis and Integration Test ([`6e70e1b`](https://github.com/ruiheesi/DSPWorkflow/commit/6e70e1bcce4d6883941547a2fe3cd43fa5d9a990))

* Integration test ([`aa78bff`](https://github.com/ruiheesi/DSPWorkflow/commit/aa78bff83d967bb68786695a77785a6641119f86))

* add integration test ([`fd211c0`](https://github.com/ruiheesi/DSPWorkflow/commit/fd211c07e0bb7ec81b938df9507b916068626084))

* update doc qc_preprocessing ([`dd82e69`](https://github.com/ruiheesi/DSPWorkflow/commit/dd82e69d9ebdf4ca28c3457edd9e1d229d3c5e0b))

* fixed conflicts ([`396baff`](https://github.com/ruiheesi/DSPWorkflow/commit/396baff797758f34e1d1ce062e44f7167bd02c82))

* hardcoded the path to the pkc file as for some reason, it does not resolve correctly when I run the test ([`73a2348`](https://github.com/ruiheesi/DSPWorkflow/commit/73a2348380bc8fee21d6131a9ee2893bda026eaf))

* removed NAMESPACE as it creates conflicts ([`c3263bf`](https://github.com/ruiheesi/DSPWorkflow/commit/c3263bf9e53d1c2dc3ee209462a66ba17773d307))

* Update ([`a5fb987`](https://github.com/ruiheesi/DSPWorkflow/commit/a5fb987ee087350a86e6aeaf32dd46b9f47d19b2))

* Update testheatmap.R ([`16af7ba`](https://github.com/ruiheesi/DSPWorkflow/commit/16af7badac985ba8354323f5fdcd0c21640590c4))

* Update ([`73697b5`](https://github.com/ruiheesi/DSPWorkflow/commit/73697b52c29a96cf1e0da61cf55f2d99803c43f4))

* update fixtures dsp.obj.rds ([`fe27836`](https://github.com/ruiheesi/DSPWorkflow/commit/fe27836e8f9ccd75757316ea8a83e55465a9539b))

* adding man dir ([`1adad0f`](https://github.com/ruiheesi/DSPWorkflow/commit/1adad0fd84d13541dbc4cc7ecebecacb0f12f8f0))

* Confirmed changed on github ([`e502ca1`](https://github.com/ruiheesi/DSPWorkflow/commit/e502ca17e813cfd636819f4ea213601b6827b7e6))

* changed test-study-design.R code for new annotation file ([`668bbe6`](https://github.com/ruiheesi/DSPWorkflow/commit/668bbe65d5c6ea9320ee967e0f8ee2fe42e31bc4))

* update ([`6b9ddd5`](https://github.com/ruiheesi/DSPWorkflow/commit/6b9ddd5dd5d86b384f2b26c1fa29565c34363f93))

* update ([`971c5ef`](https://github.com/ruiheesi/DSPWorkflow/commit/971c5ef7db74032385f902a14325e6a876b44bdf))

* correct percentStitched in plot qc_preprocessing ([`4c42cdb`](https://github.com/ruiheesi/DSPWorkflow/commit/4c42cdbd4552fb9ac9e77064b678640ef66776dc))

* update documentation qc_preprocessing ([`8436a74`](https://github.com/ruiheesi/DSPWorkflow/commit/8436a740ef24e602dc7ca40ad24d42514b42a32c))

* re-stash qc_preprocessing ([`3354b8e`](https://github.com/ruiheesi/DSPWorkflow/commit/3354b8ed24d58c6e64d693dc76128fe6ac026805))

* re-stash qc_processing.R ([`4cfc175`](https://github.com/ruiheesi/DSPWorkflow/commit/4cfc1753865a3b95d1d272f44c0383801d71c757))

* add dsp.obj.rds to fixtures ([`9b23443`](https://github.com/ruiheesi/DSPWorkflow/commit/9b2344390934d84413901cebb9b28dd69db2f3b6))

* add test-gc.preprocessing ([`eb1fda0`](https://github.com/ruiheesi/DSPWorkflow/commit/eb1fda0bf28293f6ce490f126a92555c88e443aa))

* first commitd qc_preprocessing ([`c6d28d7`](https://github.com/ruiheesi/DSPWorkflow/commit/c6d28d75af726e05165c03a506ba90825ef1a72b))

* Updated ([`9bb6cd5`](https://github.com/ruiheesi/DSPWorkflow/commit/9bb6cd5caf21d62e10025170988579b35a97dd13))

* Updated Filtering Lib ([`2479487`](https://github.com/ruiheesi/DSPWorkflow/commit/2479487ec9598d7d0126379fe183d809ef0f86ee))

* Updated Filtering Lib ([`7aed732`](https://github.com/ruiheesi/DSPWorkflow/commit/7aed7325da284672dab10fd28b10025d17f4aa42))

* “Update” ([`f9ad5ad`](https://github.com/ruiheesi/DSPWorkflow/commit/f9ad5ad57a0b28eef55ad1e8487cebe00cf9cea0))

* “Update” ([`5aa0367`](https://github.com/ruiheesi/DSPWorkflow/commit/5aa0367c659b3d5d3b3b51cb22a758661d93ca84))

* “Update” ([`a373537`](https://github.com/ruiheesi/DSPWorkflow/commit/a3735379921cbdef3c08ec5cb902a3c3d3f6cc0e))

* add violin function ([`6b15fbd`](https://github.com/ruiheesi/DSPWorkflow/commit/6b15fbd4b08e0dbc2a8c623959ea6c036606b5f4))

* Filtering ([`5567090`](https://github.com/ruiheesi/DSPWorkflow/commit/556709075ec0aa70c0a1f9f2fa79f97a5a2c2f6f))

* Filtering ([`63301d1`](https://github.com/ruiheesi/DSPWorkflow/commit/63301d11da1b6d9e7d3a982bf3854ff3086df2f5))

* Filtering ([`43e4055`](https://github.com/ruiheesi/DSPWorkflow/commit/43e4055878af05a95e71728bc3cd7fdf96002405))

* Filtering ([`5b41df2`](https://github.com/ruiheesi/DSPWorkflow/commit/5b41df23e73643386f55354d881745fb73adc5ac))

* Filtering Test ([`74b56ce`](https://github.com/ruiheesi/DSPWorkflow/commit/74b56ce2e2eaf51dea825cb073c1cc2ec8133134))

* Updated Fx ([`bd05cb9`](https://github.com/ruiheesi/DSPWorkflow/commit/bd05cb965bcaa263542149868b16326a83beedd6))

* Filtering Packages Add ([`87949f0`](https://github.com/ruiheesi/DSPWorkflow/commit/87949f0393b236f8522993e6e8fc120f5d1c8677))

* fixed warning related to global variable ([`54abb0b`](https://github.com/ruiheesi/DSPWorkflow/commit/54abb0be78f82542f03c4146aa1bb7ede8768ce8))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`c08bf71`](https://github.com/ruiheesi/DSPWorkflow/commit/c08bf716acc64421d48400a99cd64f58a1f30108))

* remove tidyverse incompatible code ([`9832f49`](https://github.com/ruiheesi/DSPWorkflow/commit/9832f498edf4f9519020e2896421f9a9eb254831))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`c70e393`](https://github.com/ruiheesi/DSPWorkflow/commit/c70e3932d79988302a69ce39ff0a3b4d35345516))

* changed data to object ([`b469837`](https://github.com/ruiheesi/DSPWorkflow/commit/b46983783ad21a587ca36f616507237451a3ac5c))

* Fixed conflicts in NAMESPACE ([`871e3ba`](https://github.com/ruiheesi/DSPWorkflow/commit/871e3ba91b86b32b75ce309d304a6902db0c1d95))

* Updated NAMESPACE ([`2bab123`](https://github.com/ruiheesi/DSPWorkflow/commit/2bab123a8dd970b99506f657eebfb007b19fcb2e))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`2642d36`](https://github.com/ruiheesi/DSPWorkflow/commit/2642d3681f5c11c840dca2a94d261bf6ffb8dbdb))

* Updated ([`33e0a1d`](https://github.com/ruiheesi/DSPWorkflow/commit/33e0a1d4532adde6c3cced7d659d326998372778))

* assign target.Data for rds ([`0dc3b0d`](https://github.com/ruiheesi/DSPWorkflow/commit/0dc3b0d61bd22624d180bfa2203b60a2592bcb8a))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`86e6644`](https://github.com/ruiheesi/DSPWorkflow/commit/86e664445d7d69d397af962b57b25be31647d2a4))

* update test - read rds ([`d8d5452`](https://github.com/ruiheesi/DSPWorkflow/commit/d8d5452df49bb30469ddd52c5934404f4761a5ca))

* update heatmap ([`c93a8a3`](https://github.com/ruiheesi/DSPWorkflow/commit/c93a8a3166f488a6525174d16502db24d23f4d61))

* update test-heatmap ([`3c093dc`](https://github.com/ruiheesi/DSPWorkflow/commit/3c093dc6c253f3d5221d6cee281cbe4b0e5cdfd9))

* update DESCRIPTION ([`7b72469`](https://github.com/ruiheesi/DSPWorkflow/commit/7b7246964f09b02a5be1f3c219a39d7fb92d39e7))

* update DESCRIPTION ([`7af8b4a`](https://github.com/ruiheesi/DSPWorkflow/commit/7af8b4a80981d2fe7da7cf4640407efa6f34d9ad))

* update NAMESPACE ([`c678325`](https://github.com/ruiheesi/DSPWorkflow/commit/c6783255a41a82fc88562487ce5dc3674050c327))

* update spatial_deconv ([`3673abe`](https://github.com/ruiheesi/DSPWorkflow/commit/3673abe02fbbe93ceadae9bb15baf0d7175e98a2))

* updates heatmap ([`e640a39`](https://github.com/ruiheesi/DSPWorkflow/commit/e640a3996e5e55009a0cb16fc2e9c24ca1afcba8))

* updates to diffExpr ([`8634907`](https://github.com/ruiheesi/DSPWorkflow/commit/863490740af8bd7c007902346335a68c4967c597))

* synchronizing ([`e88ca33`](https://github.com/ruiheesi/DSPWorkflow/commit/e88ca33789924404a14702cdad3ab7b81e3e63ae))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`898dd7f`](https://github.com/ruiheesi/DSPWorkflow/commit/898dd7fc2c1cfcf71f4ad74cb8ff1b9b0cbf42f7))

* resolve conflict ([`75bde30`](https://github.com/ruiheesi/DSPWorkflow/commit/75bde301e7ea2edf5ac2325e27832b1d0720c0b9))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`d2571ff`](https://github.com/ruiheesi/DSPWorkflow/commit/d2571ffa2d746812221fadebced9af3331ed46d0))

* update ([`b8195d0`](https://github.com/ruiheesi/DSPWorkflow/commit/b8195d04a43743326c8f051ef49131a8e7a7299a))

* Norm Test Data ([`6ab4b01`](https://github.com/ruiheesi/DSPWorkflow/commit/6ab4b014b86154d46d004d3403c999393f20b9e1))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main

update local rep ([`2173b63`](https://github.com/ruiheesi/DSPWorkflow/commit/2173b639524aecba7a0a964d24a90745c071aabf))

* fix conflicts ([`c4a4fae`](https://github.com/ruiheesi/DSPWorkflow/commit/c4a4fae966e69e66b2413e2d42a2cde64b74f4cf))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main

merge ([`7766a30`](https://github.com/ruiheesi/DSPWorkflow/commit/7766a300b0e0a5def3c51185946b4bd775ab1900))

* removed anndaata ([`920227e`](https://github.com/ruiheesi/DSPWorkflow/commit/920227e0e6b975147f72da194073d6b610b64927))

* update ([`947d9d5`](https://github.com/ruiheesi/DSPWorkflow/commit/947d9d58c50357c4edd3968e2758fc24cf2fd735))

* Changed results column names ([`962fb2f`](https://github.com/ruiheesi/DSPWorkflow/commit/962fb2fef245cf56e83eff83e3cf43bc4d6ad6c0))

* R/normalization.R ([`6f472af`](https://github.com/ruiheesi/DSPWorkflow/commit/6f472af846939557d41cba331a6b02101d63db1c))

* initialized local variables to NULL ([`cd2cac9`](https://github.com/ruiheesi/DSPWorkflow/commit/cd2cac938a5ba327788d11fe2363f7d75664dc2d))

* add to namespace ([`ab33e29`](https://github.com/ruiheesi/DSPWorkflow/commit/ab33e299ecd26ed3c126cdaf3e51e3b8a6e844e7))

* add to description ([`72bbbb0`](https://github.com/ruiheesi/DSPWorkflow/commit/72bbbb0f9e1d43f51772a935183c213386e75326))

* bind variables ([`777efc3`](https://github.com/ruiheesi/DSPWorkflow/commit/777efc3640d50c1b95d774db3f74fcaa15abdac4))

* update target.Data.rda ([`24b9c8a`](https://github.com/ruiheesi/DSPWorkflow/commit/24b9c8a3c6b821258fa4e0cf1d9ba40ec7754f9b))

* update importFrom ([`115c022`](https://github.com/ruiheesi/DSPWorkflow/commit/115c022ccfcec6f3d22706ee55d44fd405436c08))

* update NAMESPACE ([`99a8808`](https://github.com/ruiheesi/DSPWorkflow/commit/99a88088e5954f049711daf61863136ab95f4ee6))

* update DESCRIPTION ([`6c8d24c`](https://github.com/ruiheesi/DSPWorkflow/commit/6c8d24c566179c25b1386087a8f806459443b88d))

* resolve imports ([`e64c978`](https://github.com/ruiheesi/DSPWorkflow/commit/e64c9787549aa7371b638434a9aad0ccf686f077))

* update NAMESPACE ([`b3455c6`](https://github.com/ruiheesi/DSPWorkflow/commit/b3455c6f591d5ed43c22c3f41085eaf383d3c293))

* add Dependencies ([`47e6739`](https://github.com/ruiheesi/DSPWorkflow/commit/47e6739f62aa733771d064b576117b21bd4b9766))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`1b888b3`](https://github.com/ruiheesi/DSPWorkflow/commit/1b888b34a0ad5062922fcf6c2ff2826087dab2ad))

* Norm Test Dataset ([`4858fea`](https://github.com/ruiheesi/DSPWorkflow/commit/4858feada0ae8c15f69da72287d6f801148609e3))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`30cf956`](https://github.com/ruiheesi/DSPWorkflow/commit/30cf956ea7616d3e507c4625f781c73615b5c18d))

* Add test code ([`4cf6352`](https://github.com/ruiheesi/DSPWorkflow/commit/4cf6352bd2040056dc7685f9a09540e69e48d3ad))

* added importFrom for all used functions ([`788c500`](https://github.com/ruiheesi/DSPWorkflow/commit/788c500a0476e150e84e963d6b392e5159e76410))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`dc7370a`](https://github.com/ruiheesi/DSPWorkflow/commit/dc7370a35a2acd5491856962304f877189cd1ad4))

* returned list of output files ([`38a63a1`](https://github.com/ruiheesi/DSPWorkflow/commit/38a63a19c5ca988c6694a788e17405a045977ee5))

* returned list of output files ([`a6d04b0`](https://github.com/ruiheesi/DSPWorkflow/commit/a6d04b084908f9e4abd920faa8e9aa0411ea9325))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`422ec99`](https://github.com/ruiheesi/DSPWorkflow/commit/422ec99f7bedf08d0fe3718d68747b8e950be961))

* update unsupervised_analysis ([`db4b4fd`](https://github.com/ruiheesi/DSPWorkflow/commit/db4b4fd5e5684d78c31c70639b96caf630e250b8))

* set relative paths in test ([`7116b5d`](https://github.com/ruiheesi/DSPWorkflow/commit/7116b5d924869e0e0210f560b936b019502fb8ca))

* added tidyverse and gridExtra ([`e3c5167`](https://github.com/ruiheesi/DSPWorkflow/commit/e3c5167045c6c3ab0581c8c41a3450ac5c161f21))

* update spatial deconv ([`6f66fa3`](https://github.com/ruiheesi/DSPWorkflow/commit/6f66fa30db60eff1662b533e9e7d550c132bd13c))

* changed Depends to Imports ([`b1d8b00`](https://github.com/ruiheesi/DSPWorkflow/commit/b1d8b00075829463af1c53541786fc09104b3080))

* First commit ([`1e2761e`](https://github.com/ruiheesi/DSPWorkflow/commit/1e2761e19f41be5156ad9cc7e399254fd00c02a6))

* backing up spatial convolution code ([`82f23ed`](https://github.com/ruiheesi/DSPWorkflow/commit/82f23eda54a384f3c93182f823375aded4b4c15f))

* remove load_all ([`192bb96`](https://github.com/ruiheesi/DSPWorkflow/commit/192bb96c72ef4fd1a7ba4a42387ab68da0e0d940))

* load test_path fixtures ([`0a16efe`](https://github.com/ruiheesi/DSPWorkflow/commit/0a16efe0dbc5ad52b14ba21f585732478ecf7c0b))

* update fixtures ([`06de85d`](https://github.com/ruiheesi/DSPWorkflow/commit/06de85dd3d133cef1903c426de8b37a119bfaf94))

* update DESCRIPTION ([`99cc8c6`](https://github.com/ruiheesi/DSPWorkflow/commit/99cc8c6348907dcdf2bfab84f0924bae3da5b79c))

* description edit ([`a57bfdf`](https://github.com/ruiheesi/DSPWorkflow/commit/a57bfdfa47dd64dc050b3fb5f40b4aa07d96cf42))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main

Conflicts:
	DESCRIPTION
	NAMESPACE ([`6631fc3`](https://github.com/ruiheesi/DSPWorkflow/commit/6631fc351980a030ec6025fa693e0c65eb8d3d67))

* update dependencies ([`8a8bbc6`](https://github.com/ruiheesi/DSPWorkflow/commit/8a8bbc69d42b602aa11eba56727e19561099d705))

* update function name, import ([`357f7fa`](https://github.com/ruiheesi/DSPWorkflow/commit/357f7fad2a94a49a5a5914c139f2084f669c9a19))

* update function name, import ([`e00ac2c`](https://github.com/ruiheesi/DSPWorkflow/commit/e00ac2c0a94943819cb5eedcda5b2059d4a7df4d))

* odrdered the depends section alphabetically ([`7b37e7a`](https://github.com/ruiheesi/DSPWorkflow/commit/7b37e7ac31601d99f7ce8c895e2f7135473a3bc2))

* add fixtures folder ([`1d21d98`](https://github.com/ruiheesi/DSPWorkflow/commit/1d21d98a8c8b1e1afa59ceed03b49d81d1790d51))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`c2f69ee`](https://github.com/ruiheesi/DSPWorkflow/commit/c2f69ee160f220cc54ea0a3ae9068098958b89c6))

* fixed NAMESPACE conflict ([`ab01f29`](https://github.com/ruiheesi/DSPWorkflow/commit/ab01f293f38ff60ac8bb43450427e6eea0601480))

* Update ([`13b1bc6`](https://github.com/ruiheesi/DSPWorkflow/commit/13b1bc68dbfa79dfdb57b65a1f26ed8aa323d82c))

* Initial commit ([`baa5514`](https://github.com/ruiheesi/DSPWorkflow/commit/baa5514a98370d6f2155a3ea667bf12d174ec461))

* add color.variable param ([`7ed468a`](https://github.com/ruiheesi/DSPWorkflow/commit/7ed468a187c83aef53568307bb7883c3a43eb961))

* initial commit ([`7e4255f`](https://github.com/ruiheesi/DSPWorkflow/commit/7e4255f1b67c7794989d94daf849b60b9ad3860c))

* add @import and rename function and params ([`fb5a86b`](https://github.com/ruiheesi/DSPWorkflow/commit/fb5a86b5d25a8fe61d7dff800dddf554a1f9f9c8))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`9286d6b`](https://github.com/ruiheesi/DSPWorkflow/commit/9286d6b5967ace1295acf23aa592bc12822948ce))

* initial commit ([`4b79ebd`](https://github.com/ruiheesi/DSPWorkflow/commit/4b79ebd60a3b4696ff893a2f818ec765722ff631))

* Normalization Unit Test ([`b3b51e4`](https://github.com/ruiheesi/DSPWorkflow/commit/b3b51e46f72e5b9c9d75aacd90847d0a1a524722))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`43e94fb`](https://github.com/ruiheesi/DSPWorkflow/commit/43e94fb4d516dd91414ed907888705d7b34079c4))

* Merge branch &#39;main&#39; of https://github.com/NIDAP-Community/DSPWorkflow into main ([`b93bd2a`](https://github.com/ruiheesi/DSPWorkflow/commit/b93bd2ada3340bee0087d89e4451624c1af78b2a))

* Rename the function StudyDesign and added dependencies to the DESCRIPTION file ([`b4bf7e4`](https://github.com/ruiheesi/DSPWorkflow/commit/b4bf7e490c617aca307e516e9e22929716ae6d2e))

* Delete test-normalization.R ([`84025c7`](https://github.com/ruiheesi/DSPWorkflow/commit/84025c79c5a531f33399d6413da14733d4e83008))

* Updated function ([`9aeec48`](https://github.com/ruiheesi/DSPWorkflow/commit/9aeec487ec79884bc47da7dc3f5a2d668ddc4b1b))

* Initial commit ([`b246883`](https://github.com/ruiheesi/DSPWorkflow/commit/b246883ae2810570a9c504d05d9748161e9fe2dd))

* Add files via upload ([`415666a`](https://github.com/ruiheesi/DSPWorkflow/commit/415666a37913d2efcb782443f270d8dfddb0f4f1))

* Delete test-normalization.R ([`8f72dea`](https://github.com/ruiheesi/DSPWorkflow/commit/8f72dea13713a5599df5d187744f2ca6dad0ec85))

* Add files via upload ([`09fed03`](https://github.com/ruiheesi/DSPWorkflow/commit/09fed03f515ad7ef1258533e3d0a2fe6e4f56905))

* Initial commit ([`91a3501`](https://github.com/ruiheesi/DSPWorkflow/commit/91a3501638d751cd018e6d9eb0a5ede92613b618))

* added project artifacts ([`fcf73f9`](https://github.com/ruiheesi/DSPWorkflow/commit/fcf73f9175711502163bb84ba42f29b21b9af4b2))

* first implementation of study design function ([`72abdc2`](https://github.com/ruiheesi/DSPWorkflow/commit/72abdc2120092ef0503c438881fac102fa7a5ed4))

* Commented example code ([`5c82d69`](https://github.com/ruiheesi/DSPWorkflow/commit/5c82d6943ab254779e37a836fdc36c7fa568c8d4))

* prototype of study design ([`ec478ae`](https://github.com/ruiheesi/DSPWorkflow/commit/ec478ae82ff68b14603d0cd32fcf76bafd041011))

* Rearranged folders ([`c97858a`](https://github.com/ruiheesi/DSPWorkflow/commit/c97858ab6c152152dfd3cda75ef51f434606859b))

* Added new R files ([`29f1609`](https://github.com/ruiheesi/DSPWorkflow/commit/29f1609a8ae1636c163d716ce3ad3d551f17c05d))

* Initial try ([`559a985`](https://github.com/ruiheesi/DSPWorkflow/commit/559a98520cd99d7e07550434803c171a5e40568a))

* Initial commit ([`e439dce`](https://github.com/ruiheesi/DSPWorkflow/commit/e439dce5040c825013276f9e460ab30e1d2ea729))
